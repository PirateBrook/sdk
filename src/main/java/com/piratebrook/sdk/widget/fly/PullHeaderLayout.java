...
import com.piratebrook.sdk.util.UIUtils;
import com.piratebrook.sdk.widget.fly.internal.ElasticOutInterpolator;
...
public class PullHeaderLayout extends ViewGroup {
    ...
    protected IHeaderController mHeaderController;
    ...
    public interface OnPullListener {
        void onPullProgress(IPullHeader view, int state, float progress);
    }
    ...
    public PullHeaderLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PullHeaderLayout);
            headerHeight = a.getDimensionPixelOffset(R.styleable.PullHeaderLayout_header_height,
                    DEFAULT_HEIGHT);
            headerExpandHeight = a.getDimensionPixelOffset(
                    R.styleable.PullHeaderLayout_header_expand_height, DEFAULT_EXPAND);
            headerShrinkHeight = a.getDimensionPixelOffset(
                    R.styleable.PullHeaderLayout_header_shrink_height, DEFAULT_SHRINK);

            mHeaderId = a.getResourceId(R.styleable.PullHeaderLayout_header, mHeaderId);
            mContentId = a.getResourceId(R.styleable.PullHeaderLayout_content, mContentId);

            mActionDrawable = a.getDrawable(R.styleable.PullHeaderLayout_action);

            a.recycle();
        }

        mHeaderController = new HeaderController(headerHeight, headerExpandHeight,
                headerShrinkHeight);
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        if (D) {
            LogUtils.d(TAG,"nestedScrollAxes = " + nestedScrollAxes);
        }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed,
                               int dyUnconsumed) {
        final int myConsumed = moveBy(dyConsumed);
    ...
    private int moveBy(float deltaY) {
        ...
        if (mPullState != STATE_DRAG) {
            mPullState = STATE_DRAG;
        }
        ...
        if (mActionView != null) {
            ...
            if (mPullListener != null) {
                mPullListener.onPullProgress(mPullHeaderView, mPullState, percentage);
            }
        }
    ...
    protected void onMoveHeader(int state, float percentage) {}
...
//            dispatchNestedScroll(0, myConsumed, 0, consumed[1], null);
    ...
    public void setActionDrawable(Drawable actionDrawable) {
        ...
        if (mActionDrawable != null) {
            if (mActionView == null) {
                final int bgColor = UIUtils.getThemeColorFromAttrOrRes(getContext(),
                        R.attr.colorAccent, R.color.accent);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContent != null) {
            measureChildWithMargins(mContent, widthMeasureSpec, 0, heightMeasureSpec,
                    mHeaderController.getMinHeight());
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                // Remember location if down touch.
                ...
                /*
                 * If being flied and user touches the screen, initiate drag;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            case MotionEvent.ACTION_DOWN: {
                ...
                /*
                 * If being fling and user touches, stop the fling. isFinished
                 * will be false if being fling.
                 */
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    final int scrollDeltaY = moveBy(deltaY);
                    final int unconsumedY = deltaY - scrollDeltaY;
                    if (dispatchNestedScroll(0, scrollDeltaY, 0,
    ...
    private void fling(int velocityY) {
        ...
        mScroller.fling(0, mHeaderController.getScroll(), 0, velocityY, 0, 0,
                mHeaderController.getMinScroll(), mHeaderController.getMaxScroll(), 0, 0);
        ViewCompat.postInvalidateOnAnimation(this);
    }
