...
import com.piratebrook.sdk.widget.fly.internal.MountainSceneView;
...
public class FlyRefreshLayout extends PullHeaderLayout {
    ...
    public void startRefresh() {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(iconView, "ScaleX", 1, 0.5f);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(iconView, "ScaleY", 1, 0.5f);

        flyUpAnim.playTogether(transX, transY, rotation, rotationX, scaleX, scaleY);
    ...
    public void onRefreshFinish() {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(iconView, "scaleX", 0.5f, 0.9f);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(iconView, "scaleY", 0.5f, 0.9f);

        flyDownAnim.playTogether(transX1, transY1, scaleX, scaleY, rotation1);
        ...
        ObjectAnimator transX2 = ObjectAnimator.ofFloat(iconView, "translationX", offDistX, 0);
        ObjectAnimator transY2 = ObjectAnimator.ofFloat(iconView, "translationY", offDistY, 0);
        ObjectAnimator rotationX2 = ObjectAnimator.ofFloat(iconView, "rotationX", 30, 0);
        ObjectAnimator scaleX2 = ObjectAnimator.ofFloat(iconView, "scaleX", 0.9f, 1f);
        ObjectAnimator scaleY2 = ObjectAnimator.ofFloat(iconView, "scaleY", 0.9f, 1f);
        flyInAnim.playTogether(transX2, transY2, rotationX2, scaleX2, scaleY2);
    ...
    protected void onMoveHeader(int state, float percentage) {
        super.onMoveHeader(state, percentage);
        if (mHeaderController.isOverHeight()) {
            getIconView().setRotation((-45) * percentage);
        }
    }
