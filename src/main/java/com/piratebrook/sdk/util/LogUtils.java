...
import com.piratebrook.sdk.component.BaseApplication;
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && BaseApplication.sInstance.getExternalCacheDir() != null)
                defaultDir = BaseApplication.sInstance.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = BaseApplication.sInstance.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
